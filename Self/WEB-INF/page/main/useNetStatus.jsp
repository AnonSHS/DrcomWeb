...
<html>
	<head>
		...
		<title>用户自助服务系统-查询服务-上网详单</title>
			...
			<div class="content_bom">
				...
				<div class="rightbox">
					...
					<div class="t_boxout">
						<div class="banner_bg">
							<div class="banner_l">
								<div class="banner_r">您现在的位置：<a href="nav_main">首页导航</a> &gt; <a href="nav_mainQuery">查询服务</a> &gt; 上网详单</div>
							</div>
						</div>
						<div class="t_boxin"><!-- 内边框 -->
				 			<div class="tabcontent" style="padding-top:30px;">						
								<s:form id="form" action="UserLoginLogAction" method="post" theme="simple" namespace="/" target="_blank">
									<input type="hidden" name="type" value="1"/>
									<div class="row">
											<a id="crrdate" href="javascript:void(0);">当日/today</a>
											<a id="crrmonth" href="javascript:void(0);">本月/month</a>
									</div>
									<div class="row">
											历史月份&nbsp;&nbsp;<s:select list="tableList" name="month" listKey="key" listValue="value" ></s:select>
											<%--<input type="button" id="btnM" value="查询"/>--%>
											<input id="btnM" type="button" class="but" value="查询" title="inquiry">
									</div>
									<div class="row">
											开始日期/start&nbsp;<input type="text" id="startDate" name="startDate" 
												onfocus="WdatePicker({dateFmt:'yyyy-MM-dd',maxDate:'#F{$dp.$D(\'endDate\')}'})" readOnly="readOnly" class="Wdate"/>
											&nbsp;&nbsp;结束日期/end&nbsp;<input type="text" id="endDate" name="endDate" 
											...
											<input id="btnD" type="button" class="but" value="查询" title="inquiry">
									</div>
									<div class="centerbut">

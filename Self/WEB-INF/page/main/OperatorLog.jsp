...
<html>
	<head>
		...
		<title>用户自助服务系统-查询服务-业务办理记录</title>
		...
		<div class="outbox">
			...
			<div class="content_bom">
				...
				<div class="t_boxout">
					<div class="banner_bg">
						<div class="banner_l">
							<div class="banner_r">您现在的位置：<a href="nav_main">首页导航</a> &gt; <a href="nav_mainQuery">查询服务</a> &gt; 业务办理记录</div>
						</div>
					</div>
					<div class="t_boxin"><!-- 内边框 -->
						 <div class="tabcontent" style="padding-top:30px;">						
							<s:form id="form" action="AdminOpLogAction" method="post" theme="simple" namespace="/" target="_blank" >			
								<s:hidden name="type"></s:hidden>
								<div class="row">
										<a id="crrdate" href="javascript:void(0);">当日</a>
										<a id="crrmonth" href="javascript:void(0);">本月</a>
									</div>
									<div class="row">
									...
									<div class="row">
										开始日期&nbsp;&nbsp;<input type="text" id="startDate" name="startDate" onfocus="WdatePicker({dateFmt:'yyyy-MM-dd',maxDate:'#F{$dp.$D(\'endDate\')}'})" readOnly="readOnly" class="Wdate"/>
										 &nbsp;&nbsp;结束日期&nbsp;&nbsp;<input type="text" id="endDate" name="endDate" 	onfocus="WdatePicker({dateFmt:'yyyy-MM-dd',minDate:'#F{$dp.$D(\'startDate\')}',maxDate:'%y-%M-%d'})" readOnly="readOnly" class="Wdate" />
